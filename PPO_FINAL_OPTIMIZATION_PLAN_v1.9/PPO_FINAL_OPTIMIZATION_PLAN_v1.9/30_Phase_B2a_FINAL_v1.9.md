# Phase B2a：拐角平滑（学习驱动）（FINAL v1.9）
版本日期：2026-01-06  
...
> v1.9 重要增补：如果你遇到“拐角仍尖角”或“总往反方向偏离”，不要直接在本 Phase 里继续堆平滑项。
> 请先执行：`32_Phase_B2a1_ArcInBand_Tangent_Learning_v1.9.md`（符号对齐 + 走廊/航向 shaping 生效），
> 再回到本 Phase 做平滑权重微调。否则很容易出现“带内允许了，但仍是尖角”。
