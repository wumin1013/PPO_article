# Phase B2c：直线效率（速度激励）（FINAL v1.9）
版本日期：2026-01-06  
...
## 7) 一键清理（可选）
仅保留：P0_L2 基线包 + aggregation + B2a/B2b/B2c 各自最优 Run Bundle。

前提：已完成 A3 聚合并更新 `main_table.csv`。

```bash
python PPO_project/tools/cleanup_keep_best.py --phases B2a,B2b,B2c --apply
```
