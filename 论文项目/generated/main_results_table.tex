\begin{table}[H]
\centering
\caption{Comparison between the final proposed method and the baseline policy on the best rollouts of representative paths.}
\label{tab:main_results}
\resizebox{0.92\textwidth}{!}{
\begin{tabular}{llcc}
\toprule
\textbf{Path} & \textbf{Metric} & \textbf{Final proposed method} & \textbf{NNC baseline}\\
\midrule
