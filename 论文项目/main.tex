...
\toprule
Configuration & Path & Outcome & Final progress & \begin{tabular}[c]{@{}c@{}}Peak contour\\error [mm]\end{tabular} & \begin{tabular}[c]{@{}c@{}}Peak jerk-limit\\exceedance\end{tabular} & Elapsed time [s]\\
\midrule
