...
\toprule
\textbf{Configuration} & \textbf{Path} & \textbf{Status} & \textbf{Progress} & \begin{tabular}[c]{@{}c@{}}\textbf{Max contour}\\\textbf{error [mm]}\end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{Max jerk}\\\textbf{exceedance}\end{tabular} & \textbf{Time [s]}\\
\midrule
